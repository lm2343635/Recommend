        ...
        types: [
            {
                ...
                name: "清洗洗衣机（原价88,现价68元/台，佣金=5元×3倍）",
                value: "清洗洗衣机"
            },{
                name: "清洗空调挂机（原价88,现价68元/台，佣金=5元×3倍）",
                value: "清洗空调挂机"
            },{
                name: "清洗空调柜机（原价138,现价118元/台，佣金=8元×3倍）",
                value: "清洗空调柜机"
            },{
                name: "清洗空调天花机（原价158,现价138元/台，佣金=10元×3倍）",
                value: "清洗空调天花机"
            },{
                name: "清洗中央空调（原价298,现价278元/台，佣金=30元×3倍）",
                value: "清洗中央空调"
            },{
                name: "清洗单开门冰箱（原价108,现价88元/台，佣金=8元×3倍）",
                value: "清洗单开门冰箱"
            },{
                name: "清洗多开门冰箱（原价138,现价118元/台，佣金=10元×3倍）",
                value: "清洗多开门冰箱"
            },{
                name: "清洗灶台（原价68,现价48元/台，佣金=5元×3倍）",
                value: "清洗灶台"
            },{
                name: "清洗微波炉（原价68,现价48元/台，佣金=5元×3倍）",
                value: "清洗微波炉"
            },{
                name: "清洗消毒柜（原价68,现价48元/台，佣金=5元×3倍）",
                value: "清洗消毒柜"
            }
        ]
    },{
